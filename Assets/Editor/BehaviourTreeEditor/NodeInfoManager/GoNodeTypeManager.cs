...
namespace Model
{
    public class GoNodeTypeManager
    {
        public static Dictionary<Type, Type> BTTypeDict { get; } = new Dictionary<Type, Type>
        {
            ...
            {typeof(Color), typeof(BTColorComponent) },
            ...
            {typeof(PlayableAsset), typeof(BTPlayableAssetComponent) },
            ...
            {typeof(ServerSubTree), typeof(BTStringComponent) }
        };
